  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600">Have a question or need help? We'd love to hear from you.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <p className="text-gray-600 text-sm">support@pakrokers.com</p>
          </div>
        ...
        <div className="md:col-span-2">
          <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-xl p-6 sm:p-8 space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-primary text-white rounded-lg hover:bg-primary-light transition-colors font-medium"
            >
              Send Message
            </button>
          </form>
